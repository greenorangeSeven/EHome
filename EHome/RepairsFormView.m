...
//    }
    ...
    if (!IS_IPHONE_5) {
        self.scrollView.contentSize = CGSizeMake(self.scrollView.bounds.size.width, self.view.bounds.size.width);
    }
...
- (IBAction)queryMyRepairsAction:(id)sender {
    MyRepairsView *myRepairsView = [[MyRepairsView alloc] init];
